...
**Artifact:** `patients-paradox-short-v0.1`  
...
```bash
python build_short.py --manifest manifests/patients_paradox_short.json --capacity-profile recovery --capacity-budget 8.0 --plan-only
```
